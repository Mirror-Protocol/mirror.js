...
var LazyGradedVestingAccount = /** @class */ (function (_super) {
     ...
     */
    function LazyGradedVestingAccount(BaseAccount, original_vesting, delegated_free, delegated_vesting, end_time, vesting_schedules) {
        var _this = _super.call(this) || this;
        _this.BaseAccount = BaseAccount;
    ...
    LazyGradedVestingAccount.prototype.toData = function () {
        var _a = this, BaseAccount = _a.BaseAccount, original_vesting = _a.original_vesting, delegated_free = _a.delegated_free, delegated_vesting = _a.delegated_vesting, end_time = _a.end_time, vesting_schedules = _a.vesting_schedules;
        return {
    ...
    LazyGradedVestingAccount.fromData = function (data) {
        var _a = data.value, _b = _a.BaseVestingAccount, BaseAccount = _b.BaseAccount, original_vesting = _b.original_vesting, delegated_free = _b.delegated_free, delegated_vesting = _b.delegated_vesting, end_time = _b.end_time, vesting_schedules = _a.vesting_schedules;
        return new LazyGradedVestingAccount(Account_1.Account.fromData({
            type: 'core/Account',
            value: BaseAccount,
        }), Coins_1.Coins.fromData(original_vesting), Coins_1.Coins.fromData(delegated_free), Coins_1.Coins.fromData(delegated_vesting), Number.parseInt(end_time), vesting_schedules.map(function (vs) {
