...
export declare class LazyGradedVestingAccount extends JSONSerializable<LazyGradedVestingAccount.Data> {
     ...
     */
    constructor(BaseAccount: Account, original_vesting: Coins, delegated_free: Coins, delegated_vesting: Coins, end_time: number, vesting_schedules: LazyGradedVestingAccount.VestingSchedule[]);
