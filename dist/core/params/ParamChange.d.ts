...
export declare namespace ParamChanges {
    const ConversionTable: {
        ...
        market: {
            ...
            illiquidtobintaxlist: (((c: import("../market/params").TaxRate.Data[]) => import("../market/params").TaxRate[]) | ((c: import("../market/params").TaxRate[]) => import("../market/params").TaxRate.Data[]))[];
        };
        gov: {
