...
export declare class TxAPI extends BaseAPI {
     ...
     */
    broadcast(tx: StdTx): Promise<TxBroadcastResult<Block, TxSuccess | TxError>>;
    /**
     ...
     */
    broadcastSync(tx: StdTx): Promise<TxBroadcastResult<Sync, {} | TxError>>;
    /**
     * Broadcast the transaction using the "async" mode, returning after CheckTx() is performed.
     * @param tx transaction to broadcast
     */
    broadcastAsync(tx: StdTx): Promise<TxBroadcastResult<Async, {}>>;
    /**
