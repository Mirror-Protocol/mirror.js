...
export declare class ContractClient {
    ...
    protected createInstantiateMsg(initMsg: any, initCoins: string | Coins | Coins.DataDict | import("@terra-money/terra.js").Coin[] | undefined, migratable: boolean): MsgInstantiateContract;
}
